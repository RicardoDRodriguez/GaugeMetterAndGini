...
class DataBase {
  ...
  static participantes = [
   ...
   /*
    new Participante("Apresentação dialogada", 1, 1, "Professor", "avatar", 10, 3006),
   ...
   */
   /* 
    new Participante("Apresentando-se para a Turma", 1, 1, "Professor", "avatar", 10, 1362),
    ...
    */
    ...
    /* 
    new Participante("Apresentando-se (conversação em fila)"    , 1, 1, "Professor", "avatar", 10, 852),
   ...
   */ 
     ...
     /* 
    new Participante("Apresentação dialogada (focada no professor)"    , 1, 1, "Professor", "avatar", 10, 4926),
  ...
  /*
    new Participante("Conversa centrada no Professor e Elisa"    , 1, 1, "Professor"  , "avatar", 10, 2760),
   ...
   */
   ...
   /*  
    new Participante("Conversação Livre (Atividade post-it)"    , 1, 1, "Professor"   , "avatar", 10, 828),
  ...
  /*
    new Participante("Aula dialogada - Tecnologias Digitais"    , 1, 1, "Professor"   , "avatar", 10, 4014),
